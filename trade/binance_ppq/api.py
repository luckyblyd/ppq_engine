...
from binance_ppq.error import ClientError, ServerError
from binance_ppq.lib.utils import get_timestamp
from binance_ppq.lib.utils import cleanNoneValue
from binance_ppq.lib.utils import encoded_string
from binance_ppq.lib.utils import check_required_parameter
from binance_ppq.lib.authentication import hmac_hashing, rsa_signature, ed25519_signature
        ...
        self.session.headers.update(
            {
                ...
                "User-Agent": "binance_ppq-connector-python/" + __version__,
