from binance_ppq.lib.utils import check_required_parameter, convert_list_to_json_array
from binance_ppq.lib.utils import check_required_parameters
...
def new_algo_order(self, symbol: str, side: str, type: str, **kwargs):
    """
    |
    | **New Algo Order (TRADE)**
    | *Place a new algo order (stop loss, take profit, etc.)*
    |
    :API endpoint: ``POST /fapi/v1/algo/order``
    :API doc: https://developers.binance.com/docs/derivatives/usds-margined-futures/trade/rest-api/New-Algo-Order
    
    :parameter symbol: string
    :parameter side: string
    :parameter type: string. Supported values: STOP, STOP_MARKET, TAKE_PROFIT, TAKE_PROFIT_MARKET
    :parameter positionSide: optional string. Default BOTH for One-way Mode; LONG or SHORT for Hedge Mode. It must be passed in Hedge Mode.
    :parameter quantity: optional float
    :parameter reduceOnly: optional string. "true" or "false"
    :parameter price: optional float. Required for STOP and TAKE_PROFIT orders
    :parameter stopPrice: optional float. Trigger price for STOP/STOP_MARKET/TAKE_PROFIT/TAKE_PROFIT_MARKET orders
    :parameter closePosition: optional string. "true" or "false". Close-All, use with STOP_MARKET or TAKE_PROFIT_MARKET
    :parameter workingType: optional string. stopPrice triggered by: "MARK_PRICE", "CONTRACT_PRICE". Default "CONTRACT_PRICE"
    :parameter priceProtect: optional string. "TRUE" or "FALSE", default "FALSE"
    :parameter timeInForce: optional string. Required for STOP and TAKE_PROFIT orders
    :parameter recvWindow: optional int
    |
    """
...
def cancel_algo_order(self, algoOrderId: int = None, origClientOrderId: str = None, **kwargs):
    """
    |
    | **Cancel Algo Order (TRADE)**
    | *Cancel an existing algo order*
    |
    :API endpoint: ``DELETE /fapi/v1/algo/order``
    :API doc: https://developers.binance.com/docs/derivatives/usds-margined-futures/trade/rest-api/Cancel-Algo-Order
    
    :parameter symbol: string
    :parameter algoOrderId: optional int
    :parameter origClientOrderId: optional string. Either algoOrderId or origClientOrderId must be sent
    :parameter recvWindow: optional int
    |
    """
...
def get_open_algo_orders(self, algoId:int = None, **kwargs):
    """
    |
    | **Get Open Algo Orders (USER_DATA)**
    | *Query all open algo orders*
    |
    :API endpoint: ``GET /fapi/v1/algoOrder``
    :API doc: https://developers.binance.com/docs/derivatives/usds-margined-futures/trade/rest-api/Query-Current-Open-Algo-Orders
    
    :parameter symbol: optional string. If not sent, orders of all symbols will be returned
    :parameter recvWindow: optional int
    |
    """
